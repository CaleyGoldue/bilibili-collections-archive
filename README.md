...
会手动从飞书在线表格导出Excel文件备份到[Google Drive个人版](https://docs.google.com/spreadsheets/d/1QUEB8C-XdE730gA903xpqncibuOsHwfm)和OneDrive国际个人版，每过半个月，即两周左右备份一次；GitHub不会进行发版，只备份CSV版本的文件到仓库里。
